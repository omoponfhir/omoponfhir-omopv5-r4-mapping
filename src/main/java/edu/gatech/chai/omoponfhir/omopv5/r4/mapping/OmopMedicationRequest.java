...
//			String resourceName = ((ReferenceParam) value).getResourceType();
		...
		case MedicationRequest.SP_AUTHOREDON:
			DateRangeParam authoredOnDateRangeParam = ((DateRangeParam) value);
			DateUtil.constructParameterWrapper(authoredOnDateRangeParam, "drugExposureStartDate", paramWrapper, mapList);
