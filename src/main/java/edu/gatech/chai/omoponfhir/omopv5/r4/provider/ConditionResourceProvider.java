...
public class ConditionResourceProvider implements IResourceProvider {
	...
	public IBundleProvider findConditionByParams(
			...
			@OptionalParam(name = Condition.SP_RECORDED_DATE) DateRangeParam theDateRecordedDateRange) {
		List<ParameterWrapper> paramList = new ArrayList<ParameterWrapper>();
		...
		if (theDateRecordedDateRange != null) {
			paramList.addAll(myMapper.mapParameter(Condition.SP_RECORDED_DATE, theDateRecordedDateRange, false));
		}
