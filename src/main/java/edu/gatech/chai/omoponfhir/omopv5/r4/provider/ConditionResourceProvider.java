...
public class ConditionResourceProvider implements IResourceProvider {
	...
	public IBundleProvider findConditionByParams(
			...
			@OptionalParam(name = Condition.SP_RECORDED_DATE) DateRangeParam theDateRecordedRange) {
		List<ParameterWrapper> paramList = new ArrayList<ParameterWrapper>();
		...
		if (theDateRecordedRange != null) {
			paramList.addAll(myMapper.mapParameter(Condition.SP_RECORDED_DATE, theDateRecordedRange, false));
		}
